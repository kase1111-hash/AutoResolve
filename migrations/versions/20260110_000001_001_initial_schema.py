...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "affected_files", postgresql.JSONB(), nullable=False, server_default="[]"
        ),
        ...
        sa.Column(
            "generation_attempts", sa.Integer(), nullable=False, server_default="1"
        ),
        sa.Column(
            "generated_at",
            sa.DateTime(timezone=True),
        ...
        sa.Column(
            "status", sa.String(50), nullable=False, server_default="pending_audit"
        ),
        sa.ForeignKeyConstraint(["issue_id"], ["issues.id"], ondelete="CASCADE"),
        sa.ForeignKeyConstraint(
            ["validation_id"], ["validations.id"], ondelete="SET NULL"
        ),
        sa.PrimaryKeyConstraint("id"),
    ...
    op.create_table(
        ...
        sa.Column(
            "scanners_used", postgresql.JSONB(), nullable=False, server_default="[]"
        ),
        ...
        sa.ForeignKeyConstraint(
            ["proposal_id"], ["fix_proposals.id"], ondelete="CASCADE"
        ),
        sa.PrimaryKeyConstraint("id"),
